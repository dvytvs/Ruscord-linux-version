## RCLinux
>[!CAUTION]
> Ruscord клиент **положен в архив!**
> Больше обновления выходить не будут.
> Билды не переведены в Typescript (Собирать прогу теперь только вам)
> Разрабы не добавили клиент на [сайт](https://russcord.ru),
> так что пусть идут нахуй
